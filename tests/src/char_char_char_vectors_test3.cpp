...
int main (int argc, char** argv){
    ros::init (argc, argv, "ros_opencl_char_char_char_vectors_test3");
    ros::NodeHandle nh;
    ...
    nh.param("ros_opencl_char_char_char_vectors_test3/kernel_filename", kernel_filename, string("test_kernels.cl"));
    nh.param("ros_opencl_char_char_char_vectors_test3/image_topic", image_topic, string("/usb_cam/image_raw"));
    nh.param("ros_opencl_char_char_char_vectors_test3/result_topic", result_topic, string("ros_opencl_char_char_char_vectors_test3/result"));
    nh.param("ros_opencl_char_char_char_vectors_test3/result_topic2", result_topic2, string("ros_opencl_char_char_char_vectors_test3/result2"));
