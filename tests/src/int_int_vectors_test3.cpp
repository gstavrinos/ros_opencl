...
int main (int argc, char** argv){
    ...
    nh.param("ros_opencl_int_int_vectors_test3/result_topic2", result_topic2, string("ros_opencl_int_int_vectors_test3/result2"));

    string full_kernel_path = ros::package::getPath("ros_opencl") + "/tests/kernels/" + kernel_filename;

    roscl = new ros_opencl::ROS_OpenCL(full_kernel_path, "doubleGrayScaleIntInt");
